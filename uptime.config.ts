...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    {
      id: 'dress-api-frontend',
      name: 'DressAPI前端',
      method: 'HEAD',
      target: 'https://dress.wsmdn.top/',
      statusPageLink: 'https://dress.wsmdn.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: 'dress-api-backend',
      name: 'DressAPI后端',
      method: 'HEAD',
      target: 'https://dress.wsmdn.top/v1/health',
      statusPageLink: 'https://dress.wsmdn.top/v1/health',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '咕咕嘎嘎API平台',
      method: 'HEAD',
      target: 'https://ai.wsmdn.top/',
      statusPageLink: 'https://ai.wsmdn.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Umami',
      method: 'HEAD',
      target: 'https://umami.wsmdn.top/',
      statusPageLink: 'https://umami.wsmdn.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
